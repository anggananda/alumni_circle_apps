...
class JobVacancies{
  ...
  JobVacancies({required this.title, required this.preview, required this.img, required this.onPressed});
}

List<JobVacancies> getJobVacancies(BuildContext context){
  return[
    JobVacancies(
      ...
      onPressed: () => {Navigator.pushNamed(context, '/detailvacancy')},
